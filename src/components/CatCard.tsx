...
const CatCard: React.FC<CatCardProps> = ({ name, breed, age, gender }) => {
  return (
    <div className="bg-white shadow-md rounded-lg p-4">
      ...
      <div className="flex flex-wrap gap-x-4 gap-y-2 text-gray-700 mb-4 text-xs">
      ...
      <button className="w-full bg-teal-300 text-teal-800 py-1.5 px-4 rounded hover:bg-teal-400 text-sm font-medium">
        View Profile
      </button>
    </div>
  );
